     ...
     <ListItem
       ...
       rightElement={
           <TouchableOpacity
            ...
            onPress = {()=>{
              var donor_Name = this.state.donorName
              item.request_status === "Book Sent" ? this.setState({donorName:donor_Name}) : this.sendBook(item)
            }}
           >
         ...
         <View style={{flex:1}}>
           {
             ...
             ?(
               <View style={styles.subtitle}>
                 <Text style={{ fontSize: 20}}>There are no item requested</Text>
               </View>
             )
             :(
               <FlatList
